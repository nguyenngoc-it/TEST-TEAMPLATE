                ...
                <div class="card-body">
                    ...
                    <form class="form-signin">
                        <div class="form-label-group">
                            <input name="user" type="text" id="inputUserame" class="form-control" placeholder="Username" required autofocus>
                        ...
                        <div class="form-label-group">
                            ...
                            <p class="help-block text-danger"><?php if (isset($_SESSION['pass'])){ echo $_SESSION['pass']; session_destroy();} ?></p>
                        </div>
